...
const MovingText = styled.div`
  ...
  color: yellow;
  position: absolute;
  animation: moveText 18s linear infinite, rotateText 10s linear infinite;
...
const Css = styled.div`
  ...
  color: red;
  position: absolute;
  animation: moveText 22s linear infinite, rotateText 12s linear infinite;
...
const JavaScript = styled.div`
  ...
  color: green;
  position: absolute;
  animation: moveText 26s linear infinite, rotateText 11s linear infinite;
